...
/**
 * Global exception handler for the WiFi positioning service.
 * Handles all exceptions and provides standardized error responses.
 */
@RestControllerAdvice
public class GlobalExceptionHandler {

    public static ResponseEntity<WifiPositioningResponse> errorResponseEntity(String message, HttpStatus status) {
        WifiPositioningResponse response = WifiPositioningResponse.genericError(message, status.value());
        return new ResponseEntity<>(response, status);
    }

    @ExceptionHandler(IllegalArgumentException.class)
    public ResponseEntity<WifiPositioningResponse> handleIllegalArgumentException(IllegalArgumentException ex) {
    ...
    public ResponseEntity<WifiPositioningResponse> handleGlobalException(Exception ex, WebRequest request) {
