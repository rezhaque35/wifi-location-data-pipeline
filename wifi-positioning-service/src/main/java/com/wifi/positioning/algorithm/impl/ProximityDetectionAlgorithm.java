...
public class ProximityDetectionAlgorithm implements PositioningAlgorithm {
    ...
    private static final double PROXIMITY_VERY_WEAK_SIGNAL_MULTIPLIER = 0.5; // ×0.5 for very weak signals
    ...
    private static final double PROXIMITY_SIGNAL_OUTLIERS_MULTIPLIER = 0.9; // Good for outlier detection
