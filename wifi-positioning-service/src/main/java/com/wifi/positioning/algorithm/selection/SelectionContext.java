 ...
 * 
 * The context includes factors that affect algorithm selection and weighting:
...
public class SelectionContext {
     ...
     * TWO_APS: 2 APs
     * THREE_APS: 3 APs
     * FOUR_PLUS_APS: 4 or more APs
     * 
     * This factor is crucial for algorithm selection as different algorithms
     * perform optimally with different numbers of APs.
     */
    ...
    /**
     * Signal distribution factor based on signal strength variation.
     * UNIFORM_SIGNALS: std dev < 3.0 dB
     * MIXED_SIGNALS: std dev 3.0-10.0 dB
     * SIGNAL_OUTLIERS: std dev > 10.0 dB
     */
    private SignalDistributionFactor signalDistribution;

    /**
     * Geometric quality factor based on GDOP (Geometric Dilution of Precision).
     * EXCELLENT_GDOP: GDOP < 2.0
