...
class WifiPositioningRequestTest {
  ...
  void setUp() {
    ...
    validScanResult = new WifiScanResult("00:11:22:33:44:55", -65.0, 2437, "test-ssid", 54, 40);
  }
  ...
  void requestWithEmptyScanResults() {
    ...
    WifiPositioningRequest request =
        new WifiPositioningRequest(
            List.of(), "mobile-app", UUID.randomUUID().toString(), "my-test-app", false);
  ...
  void requestWithNullClient() {
    ...
    WifiPositioningRequest request =
        new WifiPositioningRequest(
            List.of(validScanResult), null, UUID.randomUUID().toString(), "my-test-app", false);
    ...
    // Then
    assertFalse(violations.isEmpty());
    assertTrue(violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("client")));
  }
  ...
  void requestWithLongRequestId() {
    ...
    WifiPositioningRequest request =
        new WifiPositioningRequest(
            List.of(validScanResult), "mobile-app", longRequestId, "my-test-app", false);
    ...
    assertFalse(violations.isEmpty());
    assertTrue(
        violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("requestId")));
  }
  ...
  void defaultValues() {
    ...
    WifiPositioningRequest request =
        new WifiPositioningRequest(List.of(validScanResult), "mobile-app", requestId, null, null);
