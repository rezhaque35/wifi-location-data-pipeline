...
public class WeightedAveragePositionCombinerTest {
  ...
  public void testCombinePositionsWithSinglePosition() {
    ...
    PositionCombiner.WeightedPosition weightedPosition =
        new PositionCombiner.WeightedPosition(position, 1.0);
  ...
  public void testCombinePositionsCallsIsCollinear() {
    ...
    List<PositionCombiner.WeightedPosition> weightedPositions =
        Arrays.asList(
    ...
    try (MockedStatic<GeometricQualityFactor> mockedStatic =
        Mockito.mockStatic(GeometricQualityFactor.class)) {
