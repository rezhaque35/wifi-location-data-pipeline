...
class SelectionContextBuilderTest {
    ...
    @InjectMocks
    private SelectionContextBuilder contextBuilder;
    ...
    class GeometricQualityFactorTests {
        ...
        void shouldReturnGeometricQualityFactorForSimpleConfigurationOfAPsFromTestCase4() {
            ...
            Map<String, WifiAccessPoint> apMap = Map.of(
                "00:11:22:33:44:04", WifiAccessPoint.builder().macAddress("00:11:22:33:44:04")
                    .latitude(37.7757).longitude(-122.4202).build(),
                "00:11:22:33:44:05", WifiAccessPoint.builder().macAddress("00:11:22:33:44:05")
                    .latitude(37.7755).longitude(-122.4200).build(),
                "00:11:22:33:44:06", WifiAccessPoint.builder().macAddress("00:11:22:33:44:06")
                    .latitude(37.7753).longitude(-122.4198).build()
            );
            ...
            assertTrue(factor == GeometricQualityFactor.GOOD_GDOP || 
    ...
    private Map<String, WifiAccessPoint> createAccessPoints(double[][] coordinates) {
        ...
        for (int i = 0; i < coordinates.length; i++) {
            ...
            apMap.put(mac, WifiAccessPoint.builder()
                .macAddress(mac)
                .latitude(latitude)
                .longitude(longitude)
                .build());
