...
/**
 * Test class for algorithm selection factor enums.
 * Verifies the functionality of each factor class after refactoring.
 */
public class AlgorithmFactorTest {
    ...
    public void testSignalQualityFactor() {
        ...
        assertEquals(SignalQualityFactor.VERY_WEAK_SIGNAL, SignalQualityFactor.fromSignalStrength(-100));
        
        // Test fromWifiScans method
        List<WifiScanResult> strongSignals = Arrays.asList(
            WifiScanResult.of("AA:BB:CC:DD:EE:01", -60.0, 2450, "Test1"),
            WifiScanResult.of("AA:BB:CC:DD:EE:02", -65.0, 2450, "Test2")
        );
        assertEquals(SignalQualityFactor.STRONG_SIGNAL, SignalQualityFactor.fromWifiScans(strongSignals));
        
        List<WifiScanResult> weakSignals = Arrays.asList(
    ...
    public void testSignalDistributionFactor() {
        ...
        List<WifiScanResult> uniformSignals = Arrays.asList(
        ...
        assertEquals(SignalDistributionFactor.UNIFORM_SIGNALS, 
                     SignalDistributionFactor.fromWifiScans(uniformSignals));
        
        // Test with mixed signals
        List<WifiScanResult> mixedSignals = Arrays.asList(
        ...
        assertEquals(SignalDistributionFactor.MIXED_SIGNALS, 
    ...
    public void testGeometricQualityFactor() {
        ...
        List<Position> collinearPositions = Arrays.asList(
