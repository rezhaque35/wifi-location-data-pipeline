...
/**
 * Tests for the batch operations in WifiAccessPointRepository. Uses the
 * InMemoryWifiAccessPointRepository for testing.
 */
...
class WifiAccessPointRepositoryBatchTest {
  ...
  void batchFindAfterUpdateReturnsUpdatedVersion() {
    ...
    Map<String, WifiAccessPoint> results =
        repository.findByMacAddresses(new HashSet<>(Arrays.asList(MAC_1)));
