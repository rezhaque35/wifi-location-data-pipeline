...
/**
 * Integration tests for PositioningController to verify correct algorithm names in the HTTP responses.
 * Tests end-to-end flow from HTTP request to repository and back to response.
 */
@SpringBootTest
...
public class PositioningControllerIntegrationTest {
    ...
    void setUp() {
        ...
        WifiAccessPoint ap1 = createTestAP("00:11:22:33:44:01", 37.7749, -122.4194, 10.5, "SingleAP_Test");
        WifiAccessPoint ap2 = createTestAP("00:11:22:33:44:02", 37.7750, -122.4195, 12.5, "DualAP_Test");
    ...
    void singleAPHttpResponseShouldContainMethodsUsed() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/api/positioning/calculate")
     ...
     */
    private WifiAccessPoint createTestAP(String macAddress, double lat, double lon, double alt, String ssid) {
