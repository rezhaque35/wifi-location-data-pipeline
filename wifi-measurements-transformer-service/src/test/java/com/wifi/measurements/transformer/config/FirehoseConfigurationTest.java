...
class FirehoseConfigurationTest {
  ...
  void shouldCreateFirehoseAsyncClient() {
    ...
    FirehoseAsyncClient firehoseClient =
        firehoseConfiguration.firehoseAsyncClient(credentialsProvider, firehoseProperties);
  ...
  void shouldCreateFirehoseAsyncClientWithLocalStackEndpoint() {
    ...
    var firehoseProperties =
        new FirehoseConfigurationProperties(
            true, "test-delivery-stream", 500, 4194304L, 5000L, 1024000L, 3, 1000L);
