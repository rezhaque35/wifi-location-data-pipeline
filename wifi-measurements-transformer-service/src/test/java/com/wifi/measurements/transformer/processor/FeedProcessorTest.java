 ...
 * 
 * Tests the basic contract and behavior of feed processors including
 * feed type detection, processing capabilities, and priority handling.
 */
class FeedProcessorTest {
    ...
    private S3EventRecord createTestS3EventRecord(String streamName) {
        String objectKey = streamName + "/2025/07/28/19/" + streamName + "-2025-07-28-19-12-23-15993907-a5fe-4793-8182-064acc85cf20.txt";
