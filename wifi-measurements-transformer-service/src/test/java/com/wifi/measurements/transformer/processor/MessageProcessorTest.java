 ...
 * 
 * <p>This test class provides thorough unit testing for the MessageProcessor service,
 * covering all major functionality including successful message processing, error handling,
 * and edge cases. The tests use Mockito for dependency mocking and JUnit 5 for test execution.</p>
 * 
 * <p><strong>Test Coverage:</strong></p>
 * <ul>
 *   <li><strong>Successful Processing:</strong> Tests for successful S3 event extraction and processing</li>
 *   <li><strong>Error Handling:</strong> Tests for various failure scenarios and error conditions</li>
 *   <li><strong>Edge Cases:</strong> Tests for null inputs, malformed messages, and exception handling</li>
 *   <li><strong>Integration Points:</strong> Tests for interaction with S3EventExtractor and FeedProcessorFactory</li>
 *   <li><strong>Logging Verification:</strong> Tests for proper logging behavior and message tracking</li>
 * </ul>
 * 
 * <p><strong>Test Scenarios:</strong></p>
 * <ul>
 *   <li>Successful message processing with valid S3 events</li>
 *   <li>Handling of S3 event extraction failures</li>
 *   <li>Handling of feed processor processing failures</li>
 *   <li>Exception handling during message processing</li>
 *   <li>Null and malformed message handling</li>
 *   <li>Logging verification for successful operations</li>
 * </ul>
 * 
 * <p><strong>Mocking Strategy:</strong></p>
 * <ul>
 *   <li>S3EventExtractor is mocked to control S3 event extraction behavior</li>
 *   <li>FeedProcessorFactory is mocked to control processor selection</li>
 *   <li>FeedProcessor is mocked to control processing behavior</li>
 *   <li>All external dependencies are isolated for pure unit testing</li>
 * </ul>
 * 
...
class MessageProcessorTest {
    ...
    @Mock
    private FeedProcessor mockFeedProcessor;
    ...
    void shouldProcessMessageSuccessfullyWhenS3EventExtractionSucceeds() {
        ...
        S3EventRecord mockS3Event = new S3EventRecord(
            "test-id",
            Instant.now(),
            "us-east-1",
    ...
    void shouldHandleExceptionDuringProcessing() {
        ...
        when(s3EventExtractor.extractS3Event(messageBody)).thenThrow(new RuntimeException("Test exception"));
