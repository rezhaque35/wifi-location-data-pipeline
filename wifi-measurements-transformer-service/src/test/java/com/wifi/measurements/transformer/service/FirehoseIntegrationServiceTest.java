...
class FirehoseIntegrationServiceTest {
    ...
    @Mock
    private FirehoseMonitoringService firehoseMonitoringService;
    ...
    void setUp() {
        ...
        writer = new FirehoseIntegrationService(
            firehoseClient, 
            firehoseProperties, 
            meterRegistry, 
            retryExecutor,
    ...
    void shouldCreateCorrectFirehoseRecords() throws Exception {
        ...
        verify(firehoseClient).putRecordBatch(argThat((PutRecordBatchRequest request) -> {
            List<software.amazon.awssdk.services.firehose.model.Record> records = request.records();
