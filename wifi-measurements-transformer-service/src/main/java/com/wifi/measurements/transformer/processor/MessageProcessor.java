...
public class MessageProcessor {
   ...
   * data stream types.
   *
   * @param s3EventExtractor Service responsible for extracting S3 event information from SQS
   *     message bodies
  ...
  public MessageProcessor(
      S3EventExtractor s3EventExtractor, FeedProcessorFactory feedProcessorFactory) {
