...
public interface FeedProcessor {
   ...
   *
   * <p>This method should: 1. Download and process the S3 object 2. Apply feed-specific
  ...
  /**
   * Gets the priority of this processor for feed type resolution. Higher values indicate higher
   * priority.
   *
