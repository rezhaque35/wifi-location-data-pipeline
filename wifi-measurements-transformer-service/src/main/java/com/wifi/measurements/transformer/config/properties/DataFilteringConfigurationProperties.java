 ...
 * 
 * Configures Stage 1 sanity checks, quality weighting, and optional
 * mobile hotspot detection using OUI-based MAC address filtering.
 */
...
public record DataFilteringConfigurationProperties(
    ...
    @Valid
    MobileHotspotConfiguration mobileHotspot
) {
    ...
    public record MobileHotspotConfiguration(
        ...
        @NotNull(message = "Mobile hotspot enabled flag is required")
        Boolean enabled,
        
        /**
         * Set of OUI prefixes (first 3 octets) for known mobile device manufacturers.
         * Example: "00:23:6C" for Apple devices.
         */
        Set<String> ouiBlacklist,
        
        /**
         * Action to take when mobile hotspot is detected.
         * Options: FLAG, EXCLUDE, LOG_ONLY
         */
        @NotNull(message = "Mobile hotspot action is required")
        MobileHotspotAction action
    ) {
