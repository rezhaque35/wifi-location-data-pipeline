...
/**
 * Enhanced health indicator for Kinesis Data Firehose delivery stream connectivity and readiness monitoring.
 * 
 * <p>This health indicator provides comprehensive readiness checks for the Firehose delivery stream,
 * ensuring the service is ready to receive traffic and deliver data. It performs detailed connectivity
 * checks, stream status validation, and delivery readiness assessment based on the pattern from
 * the wifi-scan-queue-consumer implementation.</p>
 * 
 * <p><strong>Readiness Health Checks:</strong></p>
 * <ul>
 *   <li><strong>Stream Connectivity:</strong> Basic Firehose delivery stream accessibility and responsiveness</li>
 *   <li><strong>Stream Status:</strong> Comprehensive stream status validation (ACTIVE required)</li>
 *   <li><strong>Stream Configuration:</strong> Delivery stream configuration and destination validation</li>
 *   <li><strong>Delivery Readiness:</strong> Service readiness for data delivery operations</li>
 *   <li><strong>Connection Stability:</strong> Recent connection success tracking and failure monitoring</li>
 * </ul>
 * 
 * <p><strong>Health Status Criteria:</strong></p>
 * <ul>
 *   <li><strong>UP:</strong> Stream is ACTIVE, accessible, and ready for data delivery</li>
 *   <li><strong>DOWN:</strong> Stream is unreachable, not ACTIVE, or delivery not ready</li>
 * </ul>
 * 
 * <p><strong>Readiness Validation:</strong></p>
 * <ul>
 *   <li>Delivery stream accessibility and valid configuration</li>
 *   <li>AWS credentials and permissions validation</li>
 *   <li>Data delivery pipeline readiness</li>
 *   <li>Recent stream connectivity within acceptable timeframe</li>
 * </ul>
 */
@Component("firehose")
public class FirehoseHealthIndicator implements HealthIndicator {
    ...
    public FirehoseHealthIndicator(FirehoseClient firehoseClient, 
    ...
    public Health health() {
        try {
            ...
            boolean isReady = streamAccessible && streamReady && 
