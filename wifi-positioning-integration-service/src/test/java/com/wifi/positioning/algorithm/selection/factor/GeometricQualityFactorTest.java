...
public class GeometricQualityFactorTest {
  ...
  public void testIsCollinearWithFewerThanThreePositions() {
    // Single position
    List<Position> singlePosition = Arrays.asList(Position.of(51.5074, -0.1278));
    assertFalse(GeometricQualityFactor.isCollinear(singlePosition));

    // Two positions
    List<Position> twoPositions =
        Arrays.asList(Position.of(51.5074, -0.1278), Position.of(48.8566, 2.3522));
  ...
  public void testIsCollinearWithNonCollinearPositions() {
    List<Position> nonCollinearPositions =
        Arrays.asList(
  ...
  public void testIsCollinearWithTrianglePositions() {
    List<Position> trianglePositions =
        Arrays.asList(Position.of(0.0, 0.0), Position.of(0.0, 1.0), Position.of(1.0, 0.0));
  ...
  public void testIsCollinearWithNearlyCollinearPositions() {
    ...
    List<Position> nearlyCollinearPositions =
        Arrays.asList(
            Position.of(40.0, -74.0),
  ...
  public void testDetermineGeometricQualityWithCollinearAPs() {
    ...
    assertEquals(
        GeometricQualityFactor.COLLINEAR, factor, "Should return COLLINEAR for collinear APs");
  }
  ...
  public void testDetermineGeometricQualityWithTriangularArrangement() {
    ...
    apMap.put(
        "00:11:22:33:44:03", createAP("00:11:22:33:44:03", 37.7771, -122.4186)); // ~200m northeast
  ...
  public void testDetermineGeometricQualityWithInsufficientAPs() {
    ...
    GeometricQualityFactor factor = GeometricQualityFactor.determineGeometricQuality(scans, apMap);
    assertEquals(
        GeometricQualityFactor.POOR_GDOP, factor, "Should return POOR_GDOP for insufficient APs");
  }
