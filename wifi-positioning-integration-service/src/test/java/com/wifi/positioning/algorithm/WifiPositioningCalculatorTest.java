...
class WifiPositioningCalculatorTest {
    ...
    @InjectMocks
    private WifiPositioningCalculator wifiPositioningCalculator;
    ...
    void getCalculationInfoShouldReturnDetailedInfo() {
        ...
        WifiPositioningCalculator.PositioningResult result = 
            new WifiPositioningCalculator.PositioningResult(position, weightedAlgorithms, selectionReasons, context);
