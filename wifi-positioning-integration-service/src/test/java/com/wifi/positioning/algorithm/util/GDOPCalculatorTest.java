...
/**
 * Test suite for GDOPCalculator utility class. Ensures that calculations match existing
 * implementations in: - TrilaterationAlgorithm - MaximumLikelihoodAlgorithm -
...
class GDOPCalculatorTest {
  ...
  class GDOPCalculationTests {
    ...
    void shouldCalculateExcellentGDOPForGoodGeometry() {
      ...
      assertTrue(
          gdop <= GDOPCalculator.MAX_ALLOWED_GDOP,
    ...
    void shouldCalculatePoorGDOPForCollinearAPs() {
      ...
      assertTrue(
          gdop > GDOPCalculator.FAIR_GDOP, "Expected poor GDOP for collinear APs, got " + gdop);
    }
    ...
    void shouldHandleMinimumRequiredAPs() {
      ...
      assertEquals(
          GDOPCalculator.MAX_ALLOWED_GDOP,
          gdop,
          DELTA,
    ...
    void shouldHandle2DCoordinatesProperly() {
      ...
      assertTrue(
          gdop < GDOPCalculator.EXCELLENT_GDOP,
  ...
  class GDOPFactorTests {
    ...
    void shouldReturnFactor1ForExcellentGDOP() {
      ...
      assertEquals(1.0, factor, DELTA, "Expected factor 1.0 for excellent GDOP");
    }
    ...
    void shouldReturnFactorGreaterThan2ForPoorGDOP() {
      ...
      assertTrue(factor > 2.0, "Expected factor > 2.0 for poor GDOP, got " + factor);
    }
    ...
    void shouldCapFactorAt4ForVeryPoorGDOP() {
      ...
      assertEquals(4.0, factor, DELTA, "Expected factor capped at 4.0 for very poor GDOP");
    }
  }
  ...
  class GeometricQualityTests {
    ...
    void shouldCalculateCorrectGeometricFactorForGoodGeometry() {
      ...
      assertEquals(1.0, factor, DELTA, "Expected factor 1.0 for good geometry");
    }
    ...
    void shouldCalculateCorrectGeometricFactorForCollinearGeometry() {
      ...
      assertTrue(
          factor > GDOPCalculator.COLLINEAR_BASE_FACTOR,
