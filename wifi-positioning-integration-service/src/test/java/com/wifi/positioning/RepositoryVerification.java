...
public class RepositoryVerification {
    ...
    private static void verifyScenarioLoading(InMemoryWifiAccessPointRepository repository) {
        ...
        List<WifiAccessPoint> proximityAPList = repository.findByMacAddress("00:11:22:33:44:01")
        ...
        List<WifiAccessPoint> weakSignalAPList = repository.findByMacAddress("00:11:22:33:44:05")
            .map(ap -> Collections.singletonList(ap))
            .orElse(Collections.emptyList());
    ...
    private static void verifyBatchRetrievalAndConsistency(InMemoryWifiAccessPointRepository repository) {
        System.out.println("\n== Verifying batch retrieval and data consistency ==");
        
        // Get sample AP data for testing
        Set<String> macAddresses = new HashSet<>(Arrays.asList(
                "00:11:22:33:44:01", "00:11:22:33:44:02", "00:11:22:33:44:05"));
        ...
        System.out.println("Contains proximity AP: " + (batchResults.containsKey("00:11:22:33:44:01") ? "PASS" : "FAIL"));
        System.out.println("Contains RSSI ratio AP: " + (batchResults.containsKey("00:11:22:33:44:02") ? "PASS" : "FAIL"));
        System.out.println("Contains weak signal AP: " + (batchResults.containsKey("00:11:22:33:44:05") ? "PASS" : "FAIL"));
        ...
        for (String macAddress : macAddresses) {
            ...
            boolean match = individual.isPresent() && 
        ...
        Set<String> nonExistentMacs = new HashSet<>(Arrays.asList("99:99:99:99:99:99", "88:88:88:88:88:88"));
        Map<String, WifiAccessPoint> emptyResults = repository.findByMacAddresses(nonExistentMacs);
        System.out.println("Empty batch returns empty map: " + (emptyResults.isEmpty() ? "PASS" : "FAIL"));
        ...
        System.out.println("Mixed batch contains existing: " + (mixedResults.containsKey("00:11:22:33:44:01") ? "PASS" : "FAIL"));
        System.out.println("Mixed batch omits non-existent: " + (!mixedResults.containsKey("99:99:99:99:99:99") ? "PASS" : "FAIL"));
    }

    private static void verifyProximityDetectionScenarioData(InMemoryWifiAccessPointRepository repository) {
        ...
        if (proximityAP.isPresent()) {
            ...
            System.out.println("MAC address correct: " + ("00:11:22:33:44:01".equals(ap.getMacAddress()) ? "PASS" : "FAIL"));
            System.out.println("Has latitude/longitude: " + (ap.getLatitude() != null && ap.getLongitude() != null ? "PASS" : "FAIL"));
        ...
        Optional<WifiAccessPoint> versionSpecific = repository.findByMacAddressAndVersion("00:11:22:33:44:01", "v1.0");
        System.out.println("Version-specific lookup works: " + (versionSpecific.isPresent() ? "PASS" : "FAIL"));
    }
    ...
    private static void verifyWeakSignalsScenarioData(InMemoryWifiAccessPointRepository repository) {
        ...
        if (weakSignalAP.isPresent()) {
            ...
            System.out.println("MAC address correct: " + ("00:11:22:33:44:05".equals(ap.getMacAddress()) ? "PASS" : "FAIL"));
            System.out.println("Has latitude/longitude: " + (ap.getLatitude() != null && ap.getLongitude() != null ? "PASS" : "FAIL"));
        } else {
    ...
    private static void verifyVersionScenarios(InMemoryWifiAccessPointRepository repository) {
        ...
        Optional<WifiAccessPoint> v1 = repository.findByMacAddressAndVersion("00:11:22:33:44:99", "v1.0");
        Optional<WifiAccessPoint> v2 = repository.findByMacAddressAndVersion("00:11:22:33:44:99", "v2.0");
        ...
        Optional<WifiAccessPoint> v1After = repository.findByMacAddressAndVersion("00:11:22:33:44:99", "v1.0");
        System.out.println("V1 deleted: " + (v1After.isEmpty() ? "PASS" : "FAIL"));
        
        // Version 2 should still be there
        Optional<WifiAccessPoint> v2After = repository.findByMacAddressAndVersion("00:11:22:33:44:99", "v2.0");
