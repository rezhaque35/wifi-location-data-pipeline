...
/**
 * Represents a positioning algorithm with its associated weight and selection reason.
 * Used to track which algorithms are selected, their relative importance, and why they were selected.
 */
