...
/**
 * Data Transfer Object for positioning requests.
 * This record captures all necessary data to perform a positioning calculation.
 */
public record WifiPositioningRequest(
    ...
    /**
     * When set to true, detailed calculation information will be included in the response.
     * This includes the selection context and algorithm selection reasoning.
     */
    Boolean calculationDetail
) {
    /**
     * Compact constructor for WifiPositioningRequest.
