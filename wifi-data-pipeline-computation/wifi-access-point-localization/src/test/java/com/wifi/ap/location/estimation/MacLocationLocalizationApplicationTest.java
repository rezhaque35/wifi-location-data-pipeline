 ...
 *
 * <p>Phase 1: This simplified test verifies that the Spring Boot application can start without
 * configuration validation. Configuration properties and AWS dependencies are disabled for Phase 1
 * testing.
 */
@SpringBootTest(
    webEnvironment = SpringBootTest.WebEnvironment.NONE,
    classes = MacLocationLocalizationApplicationTest.TestConfiguration.class)
@TestPropertySource(
    properties = {
...
@ActiveProfiles("test")
class MacLocationLocalizationApplicationTest {
  ...
  @EnableAutoConfiguration(exclude = {ConfigurationPropertiesAutoConfiguration.class})
