...
/**
 * Unit tests for FirehoseConnectivityHealthIndicator (Readiness) with batch service.
 * Tests the readiness behavior that checks batch Firehose connectivity and delivery stream accessibility.
 */
...
class FirehoseConnectivityHealthIndicatorTest {
    ...
    class ConnectivityStatusTests {
        ...
        void shouldReturnUpWhenBatchFirehoseAccessible() {
            // Given
            BatchFirehoseMetrics mockMetrics = BatchFirehoseMetrics.builder()
        ...
        void shouldReturnDownWhenBatchFirehoseNotAccessible() {
            ...
            verify(batchFirehoseService, times(1)).testConnectivity();
            verify(batchFirehoseService, times(0)).getMetrics(); // Should not call getMetrics when connectivity fails
        }
    ...
    class MetricsIntegrationTests {
        ...
        void shouldCalculateBatchSuccessRateCorrectlyForVariousScenarios() {
            ...
            BatchFirehoseMetrics metrics50Percent = BatchFirehoseMetrics.builder()
                    .deliveryStreamName(DELIVERY_STREAM_NAME)
            ...
            BatchFirehoseMetrics metrics33Percent = BatchFirehoseMetrics.builder()
                    .deliveryStreamName(DELIVERY_STREAM_NAME)
                    .successfulBatches(1)
                    .failedBatches(2)
                    .totalMessagesProcessed(150)
    ...
    class ReadinessProbeIntegrationTests {
        ...
        void shouldProvideMeaningfulErrorInformationForTroubleshooting() {
            ...
            RuntimeException awsError = new RuntimeException("ResourceNotFoundException: Delivery stream 'test-stream' not found");
            ...
            assertThat(health.getStatus()).isEqualTo(Status.DOWN);
            assertThat(health.getDetails())
                    .containsEntry("error", "ResourceNotFoundException: Delivery stream 'test-stream' not found")
                    .containsKey("lastCheckTime");
        }
    }
