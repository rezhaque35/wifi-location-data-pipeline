 ...
 * 
 * This class provides comprehensive configuration for all health monitoring aspects
 * of the WiFi scan queue consumer application. It controls timeouts, thresholds,
 * behavior of custom health indicators, and integration with external monitoring
 * systems like CloudWatch and Kubernetes.
 * 
 * Key Functionality:
 * - General health indicator settings and timeouts
 * - Enhanced SSL certificate monitoring with multi-threshold warnings
 * - CloudWatch metrics integration and configuration
 * - Kubernetes event generation settings
 * - Readiness probe optimization and operational guidance
 * - Memory and consumption rate monitoring thresholds
 * 
 * High-Level Configuration Areas:
 * 1. General health monitoring settings (timeouts, thresholds, caching)
 * 2. SSL certificate monitoring with progressive warning levels
 * 3. CloudWatch integration for metrics and alerting
 * 4. Kubernetes readiness probe optimization
 * 5. Enhanced operational guidance and health scoring
 * 
 * Monitoring Integration:
 * - Supports multiple monitoring platforms (CloudWatch, Kubernetes, Prometheus)
 * - Provides configurable thresholds for different alert levels
 * - Enables caching for performance optimization
 * - Supports operational guidance for troubleshooting
 * 
 * SSL Certificate Management:
 * - Multi-stage expiration warnings (30/15/7 days)
 * - Certificate chain validation
 * - Enhanced SSL monitoring capabilities
 * - Health scoring for certificate status
 * 
...
public class HealthIndicatorConfiguration {
     ...
     * 
     * This method provides a centralized way to retrieve certificate expiration
     * thresholds based on the alert stage. It supports progressive warning levels
     * to provide early notification of certificate expiration issues.
     * 
     * Alert Stages:
     * - WARNING: Early notification (default 30 days)
     * - URGENT: Immediate attention required (default 15 days)
     * - CRITICAL: Critical action required (default 7 days)
     * 
     * Processing Steps:
     * 1. Convert stage parameter to uppercase for case-insensitive matching
     * 2. Match stage to corresponding threshold configuration
     * 3. Return appropriate threshold value
     * 4. Fall back to warning threshold for unknown stages
     * 
     * Use Cases:
     * - Health indicator configuration
     * - Alert system threshold management
     ...
     * 
     * This method determines whether the application should use enhanced
     * SSL monitoring capabilities. It requires both the general enhanced
     * monitoring flag and readiness optimization to be enabled.
     * 
     * Enhanced SSL Monitoring Features:
     * - Certificate chain validation
     * - Progressive expiration warnings
     * - Health scoring and operational guidance
     * - CloudWatch metrics integration
     * - Kubernetes event generation
     * 
     * Processing Steps:
     * 1. Check if enhanced SSL monitoring is enabled
     * 2. Check if readiness optimization is enabled
     ...
     * 
     * This method determines whether CloudWatch integration features are
     * fully operational. It requires both CloudWatch metrics export and
     * Kubernetes event generation to be enabled.
     * 
     * CloudWatch Integration Features:
     * - SSL certificate expiry metrics
     * - Health status metrics
     * - Kubernetes event generation
     * - Automated alerting and monitoring
     * 
     * Processing Steps:
     * 1. Check if CloudWatch metrics export is enabled
     * 2. Check if Kubernetes event generation is enabled
     * 3. Return true only if both conditions are met
     * 
     * Use Cases:
     * - CloudWatch integration configuration
