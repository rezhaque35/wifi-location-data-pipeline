...
start_localstack() {
    ...
    # Create docker-compose file for LocalStack in setup directory if it doesn't exist
...
EOF
    ...
    # Start LocalStack from setup directory
    cd "$SCRIPT_DIR"
...
main() {
    ...
    print_info "To stop LocalStack, run: cd $SCRIPT_DIR && docker-compose -f docker-compose-localstack.yml down"
}
